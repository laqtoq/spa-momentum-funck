...
- [x] Module B point-in-time simulator + scan mode (FR-B1–B8) · [x] Module C workbench: presets, batch runner, optimization log (FR-C1–C9)
- [ ] FR-D6 what-if · [ ] FR-D12 trade table & equity curve · [ ] R port of the screening pipeline
...
Tests: `node --test test/core.test.js test/engine/engine.test.js test/engine/indicators.test.js test/engine/monitor.test.js test/engine/buckets.test.js test/engine/kpis.test.js test/engine/simulate.test.js test/adapters.test.js test/live.test.js test/sim.test.js test/demo.test.js test/presets.test.js test/batch.test.js`
